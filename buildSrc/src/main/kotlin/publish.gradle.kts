    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/xiqbal07/futurbank/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/xiqbal07/futurbank.git")
                    developerConnection.set("scm:git:ssh://github.com/xiqbal07/futurbank.git")
                    url.set("https://github.com/xiqbal07/futurbank/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/xiqbal07/futurbank/issues")
                }
            }
        }
    }
